...
export default function Page2({index, setIndex, set}: any) {
  ...
  return (
    <>
        <div className='header flex justify-between w-[40%] items-center text-white'>
          ...
          <h2 className='text-2xl font-bold'>step 1 of 5</h2>    
        </div>
          ...
          <form onSubmit={handleSubmit} className='mt-8 flex  flex-col' action="">
            ...
            <div className='foot'>
              ...
              <div className="flex space-x-4 mt-7 divide-gray-400">
                <input value={formData.date} onChange={onChangeDate} className="date w-8/12 shadow p-5 appearance-none bg-transparent focus:border-green-600 border-2 focus:text-white border-gray-500 rounded text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="date" />
              </div>
            </div>
